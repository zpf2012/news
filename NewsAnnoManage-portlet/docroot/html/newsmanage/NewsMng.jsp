		...
		$.ajax({
			...
			success : function(data) {
				...
				html = '<table id="myTable" border="1" class="table table-bordered table-hover table-striped">'
						+ head + html + '</table>';
				$("#container").html(html);
				$("#getEntryNums").html("总共的条目有"+data.length+"条，当前为第"+page+"页");
				...
				var pageTemplate = '<li id="page_##page##">##page##</li>';
				...
				alert(getPageChildren.next().attr("id").substr(5));
			},
...
>>>>>>> afad30d7dd8ed9522b3fd798cdd1e01b724459e1
